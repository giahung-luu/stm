...
(function ($w) {
  ...
  jm.prototype = {
    ...
    continue_click_handle: function () {
      openurl = true;
    },
    click_handle: function (e) {
      ...
      if (this.view.selected_node.data.linkurl && openurl) {
    ...
    insert_node_before: function (node_before, nodeid, topic, data) {
      if (this.get_editable()) {
        ...
        var direction = this.layout.calculate_next_child_direction(
  ...
  jm.view_provider.prototype = {
    ...
    create_node_element: function (node, parent_node) {
      ...
      if (node.data.linkurl) {
        d.setAttribute("linkurl", node.data.linkurl);
      }
